<template>
  <div>
    <form @submit.prevent="editarNota(nota)" v-if="modoEditar">
      ...
      <input type="text" class="form-control mb-2" 
        placeholder="Descripción" v-model="nota.descripcion">
...
export default {
  ...
  methods:{
    ...
    editarNota(nota){
      ...
      axios.put(`/miprods/${nota.id}`, params)
        .then(res=>{
